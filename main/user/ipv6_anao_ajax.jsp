...
<table id="chen" width="100%" height="350px" border="1" align="center" style="font-family: verdana,arial,sans-serif;font-size:11px;color:#333333;border-width: 1px;border-color: #666666;border-collapse: collapse;">
	<thead>
		<tr>
			...
			<th width="150px" height="20px" style="border-width: 1px;padding: 8px;border-style: solid;border-color: #666666;background-color: #dedede;text-align:center;font-size:10px;">源IP</th>
...
<%    
         ...
         List<String> list=ud.ipv6_anom(starttime,endtime);
     ...
     %>
        <tr>
             ...
             <td width="150px" height="20px" style="border-width: 1px;padding: 8px;border-style: solid;border-color: #666666;background-color: #dedede;text-align:center;font-size:10px;"><%=list.get(i+5)%></td>
              ...
              <td width="150px" height="20px" style="border-width: 1px;padding: 8px;border-style: solid;border-color: #666666;background-color: #dedede;text-align:center;font-size:10px;"><%=list.get(i+7)%></td>
     	</tr>
      <%
          }
       %>
