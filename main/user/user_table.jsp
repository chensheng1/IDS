...
<p align="center"  style="font-size:20px;"><strong>用&nbsp;&nbsp;&nbsp;&nbsp;户&nbsp;&nbsp;&nbsp;&nbsp;统&nbsp;&nbsp;&nbsp;&nbsp;计&nbsp;&nbsp;&nbsp;&nbsp;分&nbsp;&nbsp;&nbsp;&nbsp;析&nbsp;&nbsp;&nbsp;&nbsp;表</strong></p>
...
<%    
         user_table ud=new user_table();
         List<String> list=ud.test();
         for(int i=0;i<list.size();i=i+5){
     %>
        <tr>
        	<td width="200px" style="border-width: 1px;padding: 8px;border-style: solid;border-color: #666666;background-color: #ffffff;">用户<%=(i/5)+1%></td>
