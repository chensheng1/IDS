...
<script language="javascript">  
    ...
    var XMLHttpReq;  
        ...
        function sendRequest() {  
            ...
            var url = "abnormal_user_ajax.jsp";  
        ...
        function DisplayHot() {  
        	var name = XMLHttpReq.responseXML.getElementsByTagName("abnormal"); 
            var name1 = XMLHttpReq.responseXML.getElementsByTagName("abnormal_s"); 
...
<body onload =sendRequest()>  
   <div id="app" style="width:60%;height:400px"></div>
    </body>  
</html>