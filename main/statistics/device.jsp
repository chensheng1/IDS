...
<script language="javascript">  
    ...
    var XMLHttpReq;  
        ...
        function DisplayHot() {  
        	var name = XMLHttpReq.responseXML.getElementsByTagName("device_name"); 
            var name1 = XMLHttpReq.responseXML.getElementsByTagName("device_value"); 
