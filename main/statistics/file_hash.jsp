...
<script language="javascript">  
    ...
    var XMLHttpReq;  
        ...
        function DisplayHot() {  
        	var name = XMLHttpReq.responseXML.getElementsByTagName("file_name"); 
            var name1 = XMLHttpReq.responseXML.getElementsByTagName("hash_values"); 
