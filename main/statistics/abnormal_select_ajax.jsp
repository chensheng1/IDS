...
<%
    ...
    response.setHeader("Cache-Control","no-cache"); 
         ...
         List<String> list=cs.abnormal_select(firstdate,lastdate);
          List<String> list1 =new ArrayList<String>();
		    ...
		    for(int i=0;i<list.size();i=i+5){
		    	...
		    	list3.add(Integer.parseInt(list.get(i+2))/8192);
		    	list4.add(Integer.parseInt(list.get(i+3))/8192);
		    	list5.add(Integer.parseInt(list.get(i+4))/8192);
	    ...
	    List<String> list6=cs.abnormal_high(firstdate,lastdate);
    ...
    out.println("<high>");
  	...
  	List<String> list9=cs.abnormal_low(firstdate,lastdate);
    ...
    out.println("<low>");
  	...
  	List<String> list12=cs.abnormal_low(firstdate,lastdate);
