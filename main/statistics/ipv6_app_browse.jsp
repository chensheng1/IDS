    ...
    var XMLHttpReq;  
        ...
        function DisplayHot() {  
            ...
            var conn2=conn1[0].childNodes[0].nodeValue.replace("]","");
          	...
          	var traff1 = XMLHttpReq.responseXML.getElementsByTagName("app_browse");  
					    ...
					    series : [
					        {
					            ...
					            data:[892,793,961,834,743,698,952,847,798,956,631,825,798,192,324],
					        },
					    ]
					};
