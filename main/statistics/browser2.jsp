...
<script language="javascript">  
    ...
    var XMLHttpReq;  
        ...
        function DisplayHot() {  
        	var name = XMLHttpReq.responseXML.getElementsByTagName("browser2_name"); 
            var name1 = XMLHttpReq.responseXML.getElementsByTagName("member"); 
