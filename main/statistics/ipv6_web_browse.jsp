    ...
    var XMLHttpReq;  
        ...
        function DisplayHot() {  
            ...
            var conn2=conn1[0].childNodes[0].nodeValue.replace("]","");
          	...
          	var traff1 = XMLHttpReq.responseXML.getElementsByTagName("web_browse");  
					    ...
					    series : [
					        {
					            ...
					            data:[957,872,846,790,924,858,798,937,684,893,851,791,866,240,365],
					        },
					    ]
					};
