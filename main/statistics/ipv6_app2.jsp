...
<script language="javascript">  
    ...
    var XMLHttpReq;  
        ...
        function DisplayHot() {  
        	var name = XMLHttpReq.responseXML.getElementsByTagName("app1"); 
            var name1 = XMLHttpReq.responseXML.getElementsByTagName("app_values1"); 
