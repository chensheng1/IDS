...
<script language="javascript">  
    ...
    var XMLHttpReq;  
        ...
        function DisplayHot() {  
        	var name = XMLHttpReq.responseXML.getElementsByTagName("originIP"); 
            var name1 = XMLHttpReq.responseXML.getElementsByTagName("origin_values"); 
