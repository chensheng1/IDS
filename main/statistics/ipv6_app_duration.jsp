...
<script language="javascript"> 
    var XMLHttpReq;  
        ...
        function DisplayHot() {  
            var conn1 = XMLHttpReq.responseXML.getElementsByTagName("app_time");  
            var conn2=conn1[0].childNodes[0].nodeValue.replace("]","");
          		conn2=conn2.replace("[","");
          		conn2=conn2.substring(1,conn2.length);
          	var time=conn2.split(",");
          	
          	var traff1 = XMLHttpReq.responseXML.getElementsByTagName("app_duration");  
					    ...
					    series : [
					        {
					            ...
					            data:[113,180,135,268,270,221,261,286,297,243,256,273,263,121,168],
					        },
					    ]
					};
